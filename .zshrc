...
#  ├─┤│  │├─┤└─┐
#  ┴ ┴┴─┘┴┴ ┴└─┘
alias mirrors-id="sudo reflector --verbose --latest 5 --country 'Indonesia' --age 6 --sort rate --save /etc/pacman.d/mirrorlist"
...
alias tlauncher='sudo java -jar ~/Documents/Game/TLauncher-2.885/TLauncher-2.885.jar'

alias clean='sudo pacman -Scc && sudo pacman -Rns $(pacman -Qdtq)'
